...
export class NetworkService extends EventEmitter {
  ...
  private setupEventListeners(): void {
    ...
    // Matchmaking events
    this.socket.on('matchmaking_queued', (data) => this.emit('matchmaking_queued', data));
    this.socket.on('matchmaking_success', (data) => {
      this.roomId = data.roomId;
      this.emit('matchmaking_success', data);
    });
    this.socket.on('matchmaking_canceled', () => this.emit('matchmaking_canceled'));
    ...
    this.socket.on('player_joined_room', (data) => this.emit('player_joined', data));
    this.socket.on('player_left_room', (data) => this.emit('player_left', data));

    // Gameplay events
    this.socket.on('game_state_update', (data) => this.emit('game_state_update', data));
    ...
    this.socket.on('player_collect_item', (data) => this.emit('player_collect_item', data));
    this.socket.on('player_damaged', (data) => this.emit('player_damaged', data));
    this.socket.on('player_died', (data) => this.emit('player_died', data));
    this.socket.on('player_respawn', (data) => this.emit('player_respawn', data));
   ...
   * Send a chat message.
   */
  public sendChatMessage(message: string, channel: 'global' | 'room' | 'whisper', targetPlayerId?: string): void {
