...
import { Enemy, EnemyAIConfig, Slime, FlyingEnemy } from '../entities/Enemy';
import { Item, ItemConfig, HealthPotion, Coin, SpeedBoost, Key } from '../entities/Item';
import { Skill, SkillConfig, DashSkill, FireballSkill, HealSkill } from '../entities/Skill';
import { Platform, PlatformConfig, PlatformMovement } from '../entities/Platform';
...
export class EntityFactory {
     ...
     */
    public createPlayer(x: number, y: number, config?: Partial<PlayerConfig>): Player {
     ...
     */
    public createFlyingEnemy(x: number, y: number, config?: EnemyAIConfig): FlyingEnemy {
     ...
     * @param type Enemy type ('slime' | 'flying').
     * @param x X position.
     * @param y Y position.
     * @param config Enemy AI configuration.
     */
    public createEnemy(type: 'slime' | 'flying', x: number, y: number, config?: EnemyAIConfig): Enemy {
        switch (type) {
            case 'slime':
     ...
     */
    public createHealthPotion(x: number, y: number, config?: Partial<ItemConfig>): HealthPotion {
     ...
     */
    public createSpeedBoost(x: number, y: number, config?: Partial<ItemConfig>): SpeedBoost {
     ...
     */
    public createPlatform(x: number, y: number, config?: PlatformConfig): Platform {
     ...
     */
    public createSkill(skillId: 'dash' | 'fireball' | 'heal' | SkillConfig, config?: Partial<SkillConfig>): Skill {
